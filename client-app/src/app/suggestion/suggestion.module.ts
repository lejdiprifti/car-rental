...
import { PasswordModule, FileUploadModule, CardModule, ToggleButtonModule, DialogModule, PanelModule } from 'primeng/primeng';
...
@NgModule({
    imports: [CommonsModule,DialogModule ,PanelModule, ToggleButtonModule, SuggestionRoutingModule,DataViewModule, LayoutModule,CardModule, FormsModule, PasswordModule, FileUploadModule],
    exports: [],
