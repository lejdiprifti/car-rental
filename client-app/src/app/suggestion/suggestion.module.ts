...
import { CategoryComponent } from '@ikubinfo/suggestion/category/category.component';
...
import {
    PasswordModule, FileUploadModule, CardModule, ToggleButtonModule, SelectButtonModule,
    ProgressSpinnerModule, DialogModule, SplitButtonModule, PanelModule, InplaceModule,
...
@NgModule({
    imports: [CommonsModule, DialogModule, SelectButtonModule, SplitButtonModule, FullCalendarModule,
        ProgressSpinnerModule, DropdownModule, ToggleButtonModule, KeyFilterModule, InplaceModule, PanelModule,
        ToggleButtonModule, SuggestionRoutingModule, DataViewModule, LayoutModule, CardModule, FormsModule, PasswordModule,
        FileUploadModule],
    exports: [],
    declarations: [DashboardComponent, BookingsComponent, BookingComponent, CarComponent, ClientsComponent,
        CarsComponent, UserComponent, CategoryComponent, CategoriesComponent],
    providers: []
})
